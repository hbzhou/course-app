...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-5 right-5 z-[100] flex max-h-screen w-full flex-col gap-2 p-4 sm:max-w-[360px]",
      className
    )}
    {...props}
  />
  ...
  "data-[state=open]:slide-in-from-bottom-full",
  {
    variants: {
      variant: {
        ...
        created: "border-green-200 bg-green-50 text-green-900",
        updated: "border-blue-200 bg-blue-50 text-blue-900",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex shrink-0 items-center justify-center rounded-md border px-3 text-sm font-medium transition-colors",
